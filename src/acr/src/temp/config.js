...
config.sitecoreSiteName = process.env.SITECORE_SITE_NAME || 'ACR',
...
config.sitecoreEdgeContextId = process.env.SITECORE_EDGE_CONTEXT_ID || '1EePNONeus7oHXPVW0ES85',
config.sites = process.env.SITES || '[{"name":"ACR","hostName":"*","language":"en"}]',
