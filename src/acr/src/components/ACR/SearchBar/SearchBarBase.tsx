import { SearchBarBaseProps } from './SearchBar.props';
...
/**
 * SearchBar - TODO_SCAFFOLD_FE: a good description of this component
 ...
 */
const SearchBarBase = (props: SearchBarBaseProps): JSX.Element => {
...
SearchBarBase.defaultProps = defaultProps;
