    ...
    >
      <Container px="6">
        <Grid className="md:grid-cols-12" gap="6">
          <Container className="*:flex *:flex-col *:gap-12 md:col-start-1 md:col-end-5 @container/column">
            <PlaceholderBase {...placeholderLeftProps} />
          </Container>
          <Container className="*:flex *:flex-col *:gap-12 md:col-start-5 md:col-end-13 @container/column">
