...
const Container3070 = (props: Container3070Props): JSX.Element | null => {
  ...
  const leftPlaceholders = getContainerPlaceholderProps('acr-container-30-left', props.params);
  const rightPlaceholders = getContainerPlaceholderProps('acr-container-70-right', props.params);
    ...
    >
      <Container px="6">
        <Grid className="md:grid-cols-12" gap="6">
          <Container className="md:col-start-1 md:col-end-5">
            <PlaceholderBase {...placeholderLeftProps} />
          </Container>
          <Container className="md:col-start-5 md:col-end-13">
