export const mockSitecoreContext = {
  route: {
    fields: {
      ...
      headerTitle: {
        value: 'National Medical Groups Express Growing Concern Over HHS Extended Closure of Arbitration',
      },
      subtitle: {
        value: 'AICentral.org is the premier online resource for information on FDA-cleared imaging AI tools, helping you find the algorithms that best support your patients and workflows.',
      },
    },
  },
};
